...
//            }
    ...
    private void processReturnBike(Dock d, String rentalCode, Card card){
        ...
        if (respondCode.equals("00")){
            ...
            int cost = rentBikeTransaction.getRentBikeCost();
            System.out.println(cost);
            int balance = 1000000 - cost;
            NotificationBox.display("Interbank Notification", "Số dư: " + Integer.toString(balance));
            stage.close();
        }
    }
